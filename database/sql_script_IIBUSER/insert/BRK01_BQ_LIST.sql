...
Insert into IIBUSER.BRK01_BQ_LIST (QUEUE,EXPIRY) values ('INT0080.GET.PERPERSON.FUTURE.TRIGGER.BQ','0');
Insert into IIBUSER.BRK01_BQ_LIST (QUEUE,EXPIRY) values ('INT0080.PROCESS.EMPLOYEE.FUTURE.BQ','0');
Insert into IIBUSER.BRK01_BQ_LIST (QUEUE,EXPIRY) values ('INT0080.CLEAN.DB.TRIGGER.BQ','0');
