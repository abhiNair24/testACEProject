...
Insert into IIBUSER.BRK01_ARCHIVELVL (FLOWNAME,SOURCE,ARCHIVELVL,INPUTARCHQUEUE,OUTPUTARCHQUEUE,EXPIRY,CONFIDENTIAL,ERRORIGNORE) values ('INT0080.SF_GET.PERPERSON.FUTURE.MAIN','INT0080.GET.PERPERSON.FUTURE.TRIGGER','3','ICC.ARCHIVE.DB.MSG.IN','ICC.ARCHIVE.DB.MSG.OUT','1','1','0');
Insert into IIBUSER.BRK01_ARCHIVELVL (FLOWNAME,SOURCE,ARCHIVELVL,INPUTARCHQUEUE,OUTPUTARCHQUEUE,EXPIRY,CONFIDENTIAL,ERRORIGNORE) values ('INT0080.PROCESS.EMPLOYEE.FUTURE.MAIN','INT0080.PROCESS.EMPLOYEE.FUTURE','3','ICC.ARCHIVE.DB.MSG.IN','ICC.ARCHIVE.DB.MSG.OUT','2','1','0');
Insert into IIBUSER.BRK01_ARCHIVELVL (FLOWNAME,SOURCE,ARCHIVELVL,INPUTARCHQUEUE,OUTPUTARCHQUEUE,EXPIRY,CONFIDENTIAL,ERRORIGNORE) values ('INT0080.CLEANUP.DB.MAIN','INT0080.CLEAN.DB.TRIGGER','3','ICC.ARCHIVE.DB.MSG.IN','ICC.ARCHIVE.DB.MSG.OUT','60','1','0');
