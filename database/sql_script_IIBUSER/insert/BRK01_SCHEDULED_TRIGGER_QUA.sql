...
Insert into IIBUSER.BRK01_SCHEDULED_TRIGGER (TRIGGERID,TRIGGERFLOWNAME,TRIGGERQUEUE,STARTTIME,NEXTSCHEDULE,YEAR,MONTH,DAY,HOUR,MINUT,ACTIVE) values ('''SF_To_HRDB_EmployeeFutureData'',''Sequential''','INT0080.SF_GET.PERPERSON.FUTURE.MAIN','INT0080.GET.PERPERSON.FUTURE.TRIGGER',to_timestamp('2024-02-08 17.45.00','RRRR-MM-DD HH24.MI.SS'),to_timestamp('2024-02-08 17.45.00','RRRR-MM-DD HH24.MI.SS'),null,null,null,'1',null,'No');
Insert into IIBUSER.BRK01_SCHEDULED_TRIGGER (TRIGGERID,TRIGGERFLOWNAME,TRIGGERQUEUE,STARTTIME,NEXTSCHEDULE,YEAR,MONTH,DAY,HOUR,MINUT,ACTIVE) values ('SF_HRDB_Cleanup','INT0080.CLEANUP.DB.MAIN','INT0080.CLEAN.DB.TRIGGER',to_timestamp('2024-02-07 04.00.00','RRRR-MM-DD HH24.MI.SS'),to_timestamp('2024-02-07 04.00.00','RRRR-MM-DD HH24.MI.SS'),null,null,'1',null,null,'No');
